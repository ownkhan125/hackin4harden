        ...
        {WHY_WE_WIN?.map((item, idx) => {
          ...
          return (
            ...
            >
              <Link
                href="/donate"
                aria-label={`${item.title} — donate`}
                className="block h-full rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-green-500/60 focus-visible:ring-offset-2 focus-visible:ring-offset-cream-50"
              >
                <MotionCard
                  glow="green"
                  className="border-cream-200 h-full cursor-pointer overflow-hidden rounded-xl border bg-white p-8"
                >
